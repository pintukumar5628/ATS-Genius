...
load_dotenv()
genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))  # Ensure your API key is properly configured

# Function to get Gemini response using the new model
...
def input_pdf_setup(uploaded_file):
    if uploaded_file is not None:
        ...
        # Prepare PDF content for model input
        pdf_parts = [
            {
...
the job description. Output the percentage match first, then the missing keywords, and finally your concluding thoughts.
"""
